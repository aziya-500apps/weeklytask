<template>
  <div>
    ...
    <button @click="fatchdata()">Submit</button>
    ...
    <button @click="getfun1()">filtername</button>
    ...
    <button @click="getfun2()">filter website</button>
    ...
    <button @click="getfun3()">filtercountry</button>
